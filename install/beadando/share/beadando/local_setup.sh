...
: ${AMENT_CURRENT_PREFIX:="/home/user/int_szam_mod/install/beadando"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/beadando/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/beadando/environment/path.sh"
